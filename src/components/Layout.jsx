        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-14">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="md:col-span-1">
              ...
              <div className="mt-4">
                <a
                  href="https://instagram.com/edina_boysgolf"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 bg-edina-gold/20 border border-edina-gold/40 hover:bg-edina-gold/30 rounded-lg px-4 py-2 transition-colors group"
                >
                  <svg className="w-5 h-5 text-edina-gold" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-edina-gold font-bold text-sm group-hover:text-white transition-colors">Follow @edina_boysgolf</span>
                </a>
              </div>
            </div>
          ...
          {[
            ...
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24">
                ...
                {tab.name === 'Recaps' && <path d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 12h6m-6 4h6" />}
              </svg>
              <span>{tab.name}</span>
            </Link>
          ))}
